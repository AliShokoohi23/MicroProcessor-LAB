...
; 0000 0069 leftDigits[digitIndex] = (left_number / divisor) % 10;
	LDS  R30,_digitIndex
	LDS  R31,_digitIndex+1
	LDI  R26,LOW(_leftDigits)
	LDI  R27,HIGH(_leftDigits)
	RCALL SUBOPT_0x0
	MOVW R26,R4
	RCALL SUBOPT_0x1
; 0000 006A rightDigits[digitIndex] = (right_number / divisor) % 10;
	LDS  R30,_digitIndex
	LDS  R31,_digitIndex+1
	LDI  R26,LOW(_rightDigits)
	LDI  R27,HIGH(_rightDigits)
	RCALL SUBOPT_0x0
	MOVW R26,R6
	RCALL SUBOPT_0x1
...
; 0000 006C digitIndex++;
	LDI  R26,LOW(_digitIndex)
	LDI  R27,HIGH(_digitIndex)
	LD   R30,X+
	LD   R31,X+
	ADIW R30,1
	ST   -X,R31
...
; 0000 0082 PORTC = segments[rightDigits[0]];
	LDS  R30,_rightDigits
	LDS  R31,_rightDigits+1
	RJMP _0x19
; 0000 0083 break;
; 0000 0084 case 5:
_0x14:
...
_0x19:
	SUBI R30,LOW(-_segments*2)
	SBCI R31,HIGH(-_segments*2)
	LPM  R0,Z
	OUT  0x15,R0
; 0000 008F break;
; 0000 0090 }
