...
; 0000 0025         second1 = 0;
	...
	CLR  R13
; 0000 0026         second2++;
	LDI  R26,LOW(_second2)
	LDI  R27,HIGH(_second2)
	LD   R30,X+
	LD   R31,X+
	ADIW R30,1
	ST   -X,R31
	ST   -X,R30
; 0000 0027         if (second2 == 6)
	LDS  R26,_second2
	LDS  R27,_second2+1
	SBIW R26,6
	BRNE _0x9
...
; 0000 0036                         hour2 = 0;
	...
	CLR  R7
; 0000 0037                     }
; 0000 0038                     else if (hour1 == 10 && hour2 == 0)
	RJMP _0xF
_0xC:
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
...
; 0000 006A         case (0):
	SBIW R30,0
	BRNE _0x19
; 0000 006B             PORTD = 0b11111110;
	LDI  R30,LOW(254)
	OUT  0x12,R30
; 0000 006C             PORTC = numbers[hour2];
...
_0x19:
	...
	CPC  R31,R26
	BRNE _0x1A
; 0000 0070             PORTD = 0b11111101;
	LDI  R30,LOW(253)
	OUT  0x12,R30
; 0000 0071             PORTC = numbers[hour1] | dot;
	LDI  R26,LOW(_numbers)
	LDI  R27,HIGH(_numbers)
	ADD  R26,R4
	ADC  R27,R5
...
_0x1A:
	...
	CPC  R31,R26
	BRNE _0x1B
; 0000 0075             PORTD = 0b11111011;
	LDI  R30,LOW(251)
	OUT  0x12,R30
; 0000 0076             PORTC = numbers[minute2];
	LDI  R26,LOW(_numbers)
	LDI  R27,HIGH(_numbers)
	ADD  R26,R10
	ADC  R27,R11
...
_0x1B:
	...
	CPC  R31,R26
	BRNE _0x1C
; 0000 007A             PORTD = 0b11110111;
	LDI  R30,LOW(247)
	OUT  0x12,R30
; 0000 007B             PORTC = numbers[minute1] | dot;
	LDI  R26,LOW(_numbers)
	LDI  R27,HIGH(_numbers)
	ADD  R26,R8
	ADC  R27,R9
...
_0x1C:
	...
	CPC  R31,R26
	BRNE _0x1D
; 0000 007F             PORTD = 0b11101111;
	LDI  R30,LOW(239)
	OUT  0x12,R30
; 0000 0080             PORTC = numbers[second2];
	LDS  R30,_second2
	LDS  R31,_second2+1
...
_0x1D:
	...
	CPC  R31,R26
	BRNE _0x1F
; 0000 0084             PORTD = 0b11011111;
	LDI  R30,LOW(223)
	OUT  0x12,R30
; 0000 0085             PORTC = numbers[second1] | dot;
	LDI  R26,LOW(_numbers)
	LDI  R27,HIGH(_numbers)
	ADD  R26,R12
	ADC  R27,R13
