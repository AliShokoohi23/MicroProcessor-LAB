...
;
;unsigned char int_to_char(unsigned int n) {
; 0000 000C unsigned char int_to_char(unsigned int n) {

	.CSEG
_int_to_char:
; .FSTART _int_to_char
; 0000 000D 	return n + '0';
	ST   -Y,R27
	ST   -Y,R26
;	n -> Y+0
	LD   R30,Y
...
; 0000 0010 void put_on_lcd(int value, int c) {
_put_on_lcd:
; .FSTART _put_on_lcd
; 0000 0011 	unsigned int r = 1;
...
; 0000 0019 interrupt [8] void timer1_compa_isr(void) {
_timer1_compa_isr:
...
; 0000 003F 	ICR1L = 0x00;
	OUT  0x26,R30
; 0000 0040 	OCR1AH = 0x0C;
	LDI  R30,LOW(12)
	OUT  0x2B,R30
; 0000 0041 	OCR1AL = 0x35;
	LDI  R30,LOW(53)
	OUT  0x2A,R30
...
; 0000 0046 	lcd_init(16);
	LDI  R26,LOW(16)
	RCALL _lcd_init
; 0000 0047 	lcd_gotoxy(4, 0);
	LDI  R30,LOW(4)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0048 	lcd_puts("LCD Clock");
	__POINTW2MN _0x7,0
	RCALL _lcd_puts
; 0000 0049 
; 0000 004A 	#asm("sei")
...
; 0000 004C 	while (1) {
_0x8:
; 0000 004D 		put_on_lcd(hour, 3);
	ST   -Y,R11
	ST   -Y,R10
	LDI  R26,LOW(3)
	LDI  R27,0
	RCALL _put_on_lcd
; 0000 004E 		lcd_gotoxy(5, 1);
	LDI  R30,LOW(5)
	RCALL SUBOPT_0x0
; 0000 004F 		lcd_puts(":");
	__POINTW2MN _0x7,10
	RCALL _lcd_puts
; 0000 0050 
; 0000 0051 		put_on_lcd(minute, 6);
	ST   -Y,R9
	ST   -Y,R8
	LDI  R26,LOW(6)
	LDI  R27,0
	RCALL _put_on_lcd
; 0000 0052 		lcd_gotoxy(8, 1);
	LDI  R30,LOW(8)
	RCALL SUBOPT_0x0
; 0000 0053         lcd_puts(":");
	__POINTW2MN _0x7,12
	RCALL _lcd_puts
; 0000 0054 
; 0000 0055         put_on_lcd(second, 9);
	ST   -Y,R7
	ST   -Y,R6
	LDI  R26,LOW(9)
	LDI  R27,0
	RCALL _put_on_lcd
; 0000 0056         lcd_gotoxy(11, 1);
	LDI  R30,LOW(11)
	RCALL SUBOPT_0x0
; 0000 0057         lcd_puts(":");
	__POINTW2MN _0x7,14
	RCALL _lcd_puts
; 0000 0058 
; 0000 0059         lcd_gotoxy(12, 1);
	LDI  R30,LOW(12)
	RCALL SUBOPT_0x0
; 0000 005A         lcd_putchar(int_to_char(ms));
	MOVW R26,R4
	RCALL _int_to_char
	MOV  R26,R30
	RCALL _lcd_putchar
