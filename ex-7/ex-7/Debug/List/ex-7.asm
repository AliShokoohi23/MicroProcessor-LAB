...
_0x0:
	.DB  0x4C,0x4D,0x33,0x35,0x20,0x53,0x65,0x6E
	.DB  0x73,0x6F,0x72,0x0,0x54,0x65,0x6D,0x70
	.DB  0x20,0x3A,0x0,0x43,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 002F 	lcd_init(16);
	LDI  R26,LOW(16)
	RCALL _lcd_init
; 0000 0030     lcd_gotoxy(3, 0);
	LDI  R30,LOW(3)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0031     lcd_puts("LM35 Sensor");
	__POINTW2MN _0x6,0
	RCALL _lcd_puts
; 0000 0032     lcd_gotoxy(2, 1);
	LDI  R30,LOW(2)
	RCALL SUBOPT_0x0
; 0000 0033     lcd_puts("Temp :");
	__POINTW2MN _0x6,12
	RCALL _lcd_puts
; 0000 0034     lcd_gotoxy(12, 1);
	LDI  R30,LOW(12)
	RCALL SUBOPT_0x0
; 0000 0035     lcd_putchar(223);
	LDI  R26,LOW(223)
	RCALL _lcd_putchar
; 0000 0036     lcd_gotoxy(13, 1);
	LDI  R30,LOW(13)
	RCALL SUBOPT_0x0
; 0000 0037     lcd_puts("C");
	__POINTW2MN _0x6,19
	RCALL _lcd_puts
; 0000 0038     while (1) {
_0x7:
; 0000 0039         temprature = read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R16,R30
; 0000 003A         temprature = temprature * 0.48898;
	CALL __CWD1
	CALL __CDF1
	__GETD2N 0x3EFA5B96
	CALL __MULF12
	CALL __CFD1
	MOVW R16,R30
; 0000 003B         put_on_lcd(temprature, 9);
	ST   -Y,R17
	ST   -Y,R16
	LDI  R26,LOW(9)
	LDI  R27,0
